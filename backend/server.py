...
from api.v1.endpoints import audio_cognitive_tests, user_assessment
...
app.include_router(user_assessment.router, prefix="/api/user-assessment", tags=["user-assessment"])
